    ...
    <div>
      <div className="  mt-10 scroll-mt-[90px] duration-300" id="server">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
          <div className="border-2   hover:shadow-gray-900 hover:shadow-xl border-gray-500 p-6 rounded-md shadow-sm hover:scale-10 shadow-gray-300 transition duration-300">
