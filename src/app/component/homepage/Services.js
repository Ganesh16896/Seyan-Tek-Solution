    ...
    <div className="">
      <div className="py-5">
        ...
        <p className="mt-3">
          ...
          offering precise, lane-by-lane tracking and vehicle classification for
          all types of junctions and intersections. Our expertise and advanced
          technology deliver accurate data for traffic flow analysis,
          infrastructure planning, and congestion management. We help clients
          worldwide make informed, data-driven decisions to optimize
      ...
      <div className="mt-5">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {Services.map((res) => (
            <>
              <div className="border-2 p-4 sm:p-6 bg-[#d9d9d9] rounded-lg shadow-sm">
